...
#' the function use it?
#' @param showProgress if TRUE the progress for the caret training will display
#' in the console.
#' @param progressCallback overrides the function for incrementing the progress
#' bar, intended use if for intergration into other code bases and systems.
                         ...
                         progressCallback = NULL)
{
  ...
  if(!is.null(progressCallback) && !is.function(progressCallback)) stop("progressCallback has to return a function")
