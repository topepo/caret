modelInfo <- list(label = "Local Fisher Discriminant Analysis",
                  library = NULL,
                  loop = NULL,
                  type = c("Clustering", "Pre-processing"),
                  parameters = data.frame(parameter = "parameter",
                                          class = "character",
                                          label = "parameter"),
                  grid = function(x, y, len = NULL) data.frame(parameter = "none"),
                  fit = function(x, y, r, metric = c("orthonormalized","plain","weighted"),knn = 5, ...) {
                    ...
                    # pass in the type of the transforming matrix
                  ...
                  tags = c("Local Fisher Discriminant Analysis", "Dimension Reduction", 
                           "Metric Learning", "Pre-Processing")
                  )
