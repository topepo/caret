...
This page shows a network diagram of all the models that can be accessed by `train`. See the [Revolutions blog](http://blog.revolutionanalytics.com/2014/01/predictive-models-in-r-clustered-by-tag-similarity-1.html) for details about how this visualization was made (and [this page](https://github.com/topepo/caret-archive/blob/main/html/similarity.Rhtml) has updated code using the [`networkD3`](http://cran.r-project.org/web/packages/networkD3/index.html)  package). In summary, the package annotates each model by a set of tags (e.g. "Bagging", "L1 Regularization" etc.). Using this information we can cluster models that are similar to each other. 
