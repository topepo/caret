...
---
 ...
 0. Sync `git` project
 0. Run `inst/model_sources/parseModels.R` to get new model results into package
 ...
 0. Run `inst/release_process/make_model_Rd.R` to make the models man file and move this to `man`
