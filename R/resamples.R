...
#'   \item{call }{the call} \item{values }{a data frame of results where rows
#'   correspond to resampled data sets and columns indicate the model and
#'   metric} \item{models }{a character string of model labels} \item{metrics
#'   }{a character string of performance metrics} \item{methods }{a character
#'   string of the [train()] `method` argument values for each model } For
#'   `sort.resamples` a character string in the sorted order is generated.
...
#'   but with additional elements: \item{metric }{the value for the `metric`
#'   argument} \item{call }{the call}
#'
...
#'   = "models"` and at least two when \code{variables = "metrics"}.
...
#' @return An object of class `"diff.resamples"` with elements: \item{call
...
#'   \item{statistics }{a list of results generated by `test`}
...
#' or...
#'
#' An object of class `"summary.diff.resamples"` with elements: \item{call
