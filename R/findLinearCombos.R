...
#'
#' * `linearCombos`: If there are linear combinations, this will be a list with
#'                   elements for each dependency that contains vectors of
#'                   column numbers.
#' * `remove`: a list of column numbers that can be removed to counter the
#'             linear combinations
