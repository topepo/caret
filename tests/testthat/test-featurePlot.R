...
test_that("featurePlot builds each classification plot type", {
  ...
  expect_s3_class(featurePlot(x, y, "strip"), "trellis")
  expect_s3_class(featurePlot(x, y, "box"), "trellis")
  expect_s3_class(featurePlot(x, y, "density"), "trellis")
  expect_s3_class(featurePlot(x, y, "pairs"), "trellis")
  # a factor outcome defaults to a strip plot
  expect_s3_class(featurePlot(x, y), "trellis")
})

test_that("featurePlot builds the ellipse plot", {
  skip_if_not_installed("ellipse")
  expect_s3_class(featurePlot(iris[, 1:4], iris$Species, "ellipse"), "trellis")
})
...
test_that("featurePlot builds each regression plot type", {
  ...
  expect_s3_class(featurePlot(x, y, "scatter"), "trellis")
  expect_s3_class(featurePlot(x, y, "pairs"), "trellis")
...
test_that("featurePlot handles a single predictor", {
  ...
  expect_s3_class(featurePlot(one, iris$Species, "strip"), "trellis")
