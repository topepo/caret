...
\begin{itemize}
\item Depends: required for package to function; loaded when \pkg{caret} is loaded 
\item Imports: required for package to function; not loaded
\item Suggests: the package uses it sometimes; not loaded 
\end{itemize}
