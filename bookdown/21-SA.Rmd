...
Like the other feature selection routines, `safs` can take a data recipe as an input. This is advantageous when your data needs preprocessing before the model, such as:
...
Let's fit some linear models with the function:
...
Some notes on using recipes:

 * performance data and note about where it comes in
 * variable number of columns in seach resample
