...
library(dplyr)
set.seed(1)
training <- SLC14_1(30)[, 19:21]
testing <- SLC14_1(100)[, 19:21]
...
set.seed(849)
test_reg_cv_model <- train(trainX, trainY, method = "HYFIS", 
                           tuneLength = 2,
                           trControl = rctrl1)
...
set.seed(849)
test_reg_loo_model <- train(trainX, trainY, method = "HYFIS", 
