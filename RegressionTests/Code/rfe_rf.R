...
rctrl1 <- rfeControl(method = "cv", number = 3, returnResamp = "all", functions = rfFuncs)
rctrl2 <- rfeControl(method = "LOOCV", functions = rfFuncs)
...
cctrl1 <- rfeControl(method = "cv", number = 3, returnResamp = "all", functions = rfFuncs)
cctrl2 <- rfeControl(method = "LOOCV", functions = rfFuncs)
