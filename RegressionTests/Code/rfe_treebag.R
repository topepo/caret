...
rctrl1 <- rfeControl(method = "cv", number = 3, returnResamp = "all", functions = treebagFuncs)
rctrl2 <- rfeControl(method = "LOOCV", functions = treebagFuncs)
...
cctrl1 <- rfeControl(method = "cv", number = 3, returnResamp = "all", functions = treebagFuncs)
cctrl2 <- rfeControl(method = "LOOCV", functions = treebagFuncs)
