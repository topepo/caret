...
set.seed(849)
test_reg_cv_model <- train(trainX, trainY, method = "qrnn", trControl = rctrl1,
...
test_reg_rand <- train(trainX, trainY, 
                       method = "qrnn", 
                       trControl = rctrlR,
                       tuneLength = 4, trace = FALSE,
                       iter.max = 50, n.trials = 2)

set.seed(849)
test_reg_loo_model <- train(trainX, trainY, method = "qrnn", trControl = rctrl2,
                            preProc = c("center", "scale"), trace = FALSE,
                            iter.max = 50, n.trials = 2)
